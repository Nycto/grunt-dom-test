...
define("lib", ["require", "exports", "definition"], function (require, exports, definition_1) {
    "use strict";
    var suites = [];
    var TestBuilder = (function () {
        ...
        TestBuilder.prototype.in = function (test) {
            return this.built(new definition_1.Test(this.title, this.html, test, definition_1.SkipMode.Run));
        };
        TestBuilder.prototype.skip = function (test) {
            return this.built(new definition_1.Test(this.title, this.html, test, definition_1.SkipMode.Skip));
        };
        TestBuilder.prototype.inBrowsersOnly = function (test) {
            return this.built(new definition_1.Test(this.title, this.html, test, definition_1.SkipMode.BrowserOnly));
        };
        return TestBuilder;
    }());
    ...
    var SuiteBuilder = (function () {
        function SuiteBuilder(suitePrefix, suiteTitle) {
            this.suite = new definition_1.Suite(suitePrefix, suiteTitle);
